    ...
    <main className="min-h-screen bg-background text-foreground py-16 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl space-y-10">
        <header className="rounded-[2rem] border border-border/40 bg-card/90 p-8 shadow-xl shadow-slate-900/5">
          <p className="text-sm font-semibold uppercase tracking-[0.35em] text-primary">Terms of Service</p>
          <div className="mt-4 space-y-3">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Terms &amp; Conditions for Cavaro 2.0</h1>
            <p className="text-sm text-muted-foreground">Effective Date: May 2026</p>
            <p className="text-base leading-8 text-muted-foreground">
              Welcome to Cavaro. These Terms govern your access to and use of our website, services, courses, and related content available through cavaro.com. By using our Service, you agree to comply with these Terms.
            </p>
          </div>
        </header>
        ...
        <section className="rounded-[2rem] border border-border/30 bg-card/80 p-8 shadow-sm">
          <div className="space-y-4">
            ...
            <ul className="mt-4 space-y-3 pl-6 text-sm leading-7 text-muted-foreground list-disc">
              <li>Email: admin@cavaro.co.za</li>
              <li>Phone: +27 [Your Number]</li>
            </ul>
            <p className="text-sm leading-7 text-muted-foreground">
        ...
        <section className="rounded-[2rem] border border-border/30 bg-card/80 p-8 shadow-sm">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-7 text-muted-foreground">
              All content available through the Service is the exclusive property of Cavaro or its licensors and is protected by intellectual property laws.
            </p>
        ...
        <section className="rounded-[2rem] border border-border/30 bg-card/80 p-8 shadow-sm">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-7 text-muted-foreground">To the fullest extent permitted by law, Cavaro makes no warranties regarding:</p>
            <ul className="mt-4 space-y-3 pl-6 text-sm leading-7 text-muted-foreground list-disc">
        ...
        <section className="rounded-[2rem] border border-border/30 bg-card/80 p-8 shadow-sm">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-7 text-muted-foreground">To the fullest extent permitted by South African law, Cavaro and its affiliates shall not be liable for:</p>
            <ul className="mt-4 space-y-3 pl-6 text-sm leading-7 text-muted-foreground list-disc">
            ...
            <p className="text-sm leading-7 text-muted-foreground">Our maximum liability for any claim shall not exceed the amount paid by you to Cavaro in the 12 months preceding the claim.</p>
        ...
        <section className="rounded-[2rem] border border-border/30 bg-card/80 p-8 shadow-sm">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-7 text-muted-foreground">You agree to indemnify and hold harmless Cavaro, its owners, employees, contractors, and affiliates against claims, losses, damages, liabilities, and expenses arising from:</p>
            <ul className="mt-4 space-y-3 pl-6 text-sm leading-7 text-muted-foreground list-disc">
        ...
        <section className="rounded-[2rem] border border-border/30 bg-card/80 p-8 shadow-sm">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-7 text-muted-foreground">These Terms, together with our Privacy Policy and any other policies published on the Service, constitute the full agreement between you and Cavaro regarding use of the Service.</p>
          </div>
        </section>
